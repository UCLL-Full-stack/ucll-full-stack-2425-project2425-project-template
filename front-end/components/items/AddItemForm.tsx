...
const AddItemForm: React.FC = () => {
    ...
    return (
        ...
        >
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 text-center">Add An Item</h2>
            <div className="space-y-2">
                ...
                <div>
                    <label htmlFor="pathToImage" className="block text-gray-700 font-medium mb-1">
                        Image URL:
                    </label>
                    <input
                        type="text"
