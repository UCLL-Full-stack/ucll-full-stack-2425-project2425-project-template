...
const guilds: Guild[] = [
    ...
    //         { identifier: DiscordPermission.MODERATE_MEMBERS, kanbanPermission: [KanbanPermission.VIEW_BOARD, KanbanPermission.ASSIGN_TASKS, KanbanPermission.CHANGE_TASK_STATUS, KanbanPermission.CREATE_TASKS, KanbanPermission.DELETE_TASKS, KanbanPermission.EDIT_TASKS, KanbanPermission.VIEW_ACTIVITY_LOG] },
    ...
    //     "Guild 3",
    //     [
    //         { identifier: DiscordPermission.VIEW_CHANNEL, kanbanPermission: [KanbanPermission.VIEW_BOARD] },
    //         { identifier: DiscordPermission.CREATE_INSTANT_INVITE, kanbanPermission: [KanbanPermission.ASSIGN_TASKS, KanbanPermission.MANAGE_TASK_ASSIGNEES] },
